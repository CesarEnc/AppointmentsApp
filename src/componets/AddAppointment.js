...
export const AddAppointment = ({onPublishAppointment,lastId}) => {
  ...
  let [toggleForm, setToggleForm] = useReducer( (current) => !current, false);
  let [formData, setFormData] = useState(emptyAppointment);
  ...
  const formDataPublish = () => {
    ...
    return(
        ...
        <button className={`bg-blue-400 text-white px-2 py-3 w-full text-left ${toggleForm ? "rounded-t-md" :"rounded-md"}`} onClick={setToggleForm}>
        ...
        
      {
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input type="text" name="ownerName" id="ownerName" onChange={(e) => setFormData({...formData,ownerName: e.target.value})} value = {formData.ownerName}
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input type="date" name="aptDate" id="aptDate" onChange={(e) => setFormData({...formData,aptDate: e.target.value})} value = {formData.aptDate}
              className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input type="time" name="aptTime" id="aptTime" onChange={(e) => setFormData({...formData,aptTime: e.target.value})} value = {formData.aptTime}
              className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
          </div>
        </div>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <textarea id="aptNotes" name="aptNotes" rows="3"  onChange={(e) => setFormData({...formData,aptNotes: e.target.value})} value = {formData.aptNotes}
